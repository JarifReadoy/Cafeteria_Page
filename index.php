...
<section id="banner" class="wrapper">
    <div class="container">
        ...
        <p class="banner-text">We serve the best food possible in town<br>The best for the students
        </p>
...
<section id="services" class="wrapper">
    <div class="container">
        <h4>Our Sercies</h4>
        <h2>WHAT WE OFFER</h2>
        <p class="sub-header">Various food items<br>
            Multiple dishes</p>
        <div class="cardgroup">
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <p class="card-text">Amazing dinner</p>
                </div>
            </div>
            <div class="card">
                <img src="./assets/images/image-11.jpg" alt="" class="card-img">
...
<section id="menu" class="wrapper">
    <div class="container">
        ...
        <p class="sub-header">
            Fresh and authentic taste<br>
            Good and Quality meat
        </p>
